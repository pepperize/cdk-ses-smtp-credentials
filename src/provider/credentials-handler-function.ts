 ...
 */
export class CredentialsHandlerFunction extends lambda.Function {
  constructor(scope: Construct, id: string, props?: CredentialsHandlerFunctionProps) {
    super(scope, id, {
      ...
      code: lambda.Code.fromAsset(path.join(__dirname, '../../assets/provider/credentials-handler.lambda')),
    });
